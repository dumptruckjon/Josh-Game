...
| **Backbone STAT shape as a world-wide lever** | At **0.00% budget drift**, two pure vanilla swaps took L21 heroic from median 13 to a **loss** and L17 from 10 to 5 while normal barely moved *[unverified]*. It is a real and large lever — and a cliff. Permitted **only** per level, one role at a time, sim-first, and it is deferred out of this plan. |
