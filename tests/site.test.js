...
const SCRIPTS = [
  ...
  "scripts/games-logic.js", "scripts/games-literacy.js", "scripts/main.js",
];
...
test("games self-register into the framework registry", () => {
  for (const f of ["scripts/games-toys.js", "scripts/games-math.js", "scripts/games-logic.js", "scripts/games-literacy.js"]) {
