  ...
  const LEVELS = [
    ...
    },
    {
      ...
      waves: [
        ...
        { boss: true, groups: [ { type: "vacuumking", count: 1, gap: 1, delay: 0 }, { type: "knight", count: 4, gap: 1, delay: 10 }, { type: "battery", count: 6, gap: 0.9, delay: 20 }, { type: "acorn", count: 8, gap: 0.85, delay: 32 } ] },
      ],
    },
    {
      id: 9,
    ...
    },
    {
      ...
      waves: [
        ...
        { groups: [ { type: "mitten", count: 21, gap: 0.6, delay: 0 }, { type: "knight", count: 7, gap: 0.75, delay: 3 }, { type: "screw", count: 3, gap: 0.9, delay: 4 } ] },
        { groups: [ { type: "yarn", count: 53, gap: 0.6, delay: 0 }, { type: "blob", count: 12, gap: 0.75, delay: 3 }, { type: "mole", count: 5, gap: 0.9, delay: 4 } ] },
        ...
        { groups: [ { type: "mitten", count: 28, gap: 0.6, delay: 0 }, { type: "knight", count: 8, gap: 0.75, delay: 3 }, { type: "cushion", count: 5, gap: 0.9, delay: 4 }, { type: "hawk", count: 21, gap: 0.35, delay: 2, at: 30 } ] },
        { groups: [ { type: "yarn", count: 69, gap: 0.6, delay: 0 }, { type: "blob", count: 15, gap: 0.75, delay: 3 }, { type: "slime", count: 8, gap: 0.9, delay: 4 }, { type: "tinplane", count: 13, gap: 0.35, delay: 2 } ] },
    ...
    },
    {
      ...
      waves: [
        ...
        { groups: [ { type: "knight", count: 6, gap: 0.6, delay: 0 }, { type: "mitten", count: 11, gap: 0.75, delay: 3 }, { type: "ghost", count: 5, gap: 0.9, delay: 4 }, { type: "hawk", count: 10, gap: 0.35, delay: 2 } ] },
        { groups: [ { type: "blob", count: 10, gap: 0.6, delay: 0 }, { type: "yarn", count: 30, gap: 0.75, delay: 3 }, { type: "battery", count: 4, gap: 0.9, delay: 4 }, { type: "tinplane", count: 6, gap: 0.35, delay: 2 } ] },
        ...
        { groups: [ { type: "mitten", count: 35, gap: 0.6, delay: 0 }, { type: "knight", count: 11, gap: 0.75, delay: 3 }, { type: "ghost", count: 18, gap: 0.9, delay: 4 }, { type: "hawk", count: 26, gap: 0.35, delay: 2 } ] },
        { groups: [ { type: "yarn", count: 88, gap: 0.6, delay: 0 }, { type: "blob", count: 19, gap: 0.75, delay: 3 }, { type: "battery", count: 17, gap: 0.9, delay: 4 }, { type: "tinplane", count: 17, gap: 0.35, delay: 2 } ] },
      ],
    },
    {
      id: 15,
      ...
      waves: [
        ...
        { groups: [ { type: "mitten", count: 16, gap: 0.6, delay: 0 }, { type: "knight", count: 5, gap: 0.75, delay: 3 }, { type: "screw", count: 2, gap: 0.9, delay: 4 } ] },
        { groups: [ { type: "yarn", count: 40, gap: 0.6, delay: 0 }, { type: "blob", count: 9, gap: 0.75, delay: 3 }, { type: "mole", count: 4, gap: 0.9, delay: 4 } ] },
        { groups: [ { type: "knight", count: 6, gap: 0.6, delay: 0 }, { type: "mitten", count: 14, gap: 0.75, delay: 3 }, { type: "ghost", count: 5, gap: 0.9, delay: 4 }, { type: "hawk", count: 11, gap: 0.35, delay: 2 } ] },
        { groups: [ { type: "blob", count: 11, gap: 0.6, delay: 0 }, { type: "yarn", count: 34, gap: 0.75, delay: 3 }, { type: "battery", count: 5, gap: 0.9, delay: 4 }, { type: "tinplane", count: 7, gap: 0.35, delay: 2 } ] },
        { groups: [ { type: "mitten", count: 23, gap: 0.6, delay: 0 }, { type: "knight", count: 7, gap: 0.75, delay: 3 }, { type: "cushion", count: 3, gap: 0.9, delay: 4 }, { type: "hawk", count: 15, gap: 0.35, delay: 2 } ] },
        { groups: [ { type: "yarn", count: 51, gap: 0.6, delay: 0 }, { type: "blob", count: 11, gap: 0.75, delay: 3 }, { type: "slime", count: 6, gap: 0.9, delay: 4 }, { type: "tinplane", count: 10, gap: 0.35, delay: 2 } ] },
        ...
        { groups: [ { type: "mitten", count: 40, gap: 0.6, delay: 0 }, { type: "knight", count: 12, gap: 0.75, delay: 3 }, { type: "ghost", count: 20, gap: 0.9, delay: 4 }, { type: "hawk", count: 30, gap: 0.35, delay: 2 } ] },
        { groups: [ { type: "yarn", count: 100, gap: 0.6, delay: 0 }, { type: "blob", count: 22, gap: 0.75, delay: 3 }, { type: "battery", count: 19, gap: 0.9, delay: 4 }, { type: "tinplane", count: 19, gap: 0.35, delay: 2 } ] },
