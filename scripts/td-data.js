...
(function (global) {
  ...
  const TOWERS = {
    dart: {
      name: "Dart Blaster", icon: "🎯", kind: "dart", hitsFliers: true,
      projectileSpeed: 9,
      tiers: [
    ...
    mortar: {
      name: "Block Mortar", icon: "🧱", kind: "mortar", hitsFliers: false,
      ...
      branches: {
        ...
        b: { name: "Sticky Bomb", cost: 300, dmg: 46, dmgType: "bonk", rate: 2.8, rangeMin: 1.5, range: 4.0, splash: 1.7, goo: { slow: 0.4, seconds: 2.5 } },
      },
    },
    fan: {
      name: "Freeze-Pop Fan", icon: "🧊", kind: "fan", hitsFliers: true,
      tiers: [
        { name: "Cool Breeze", cost: 100, slow: 0.3, auraRange: 1.8, zapDps: 4, zapRange: 2.2 },
        { name: "Frost Fan", cost: 160, slow: 0.4, auraRange: 2.1, zapDps: 8, zapRange: 2.4 },
        { name: "Freezer Blast", cost: 220, slow: 0.5, auraRange: 2.4, zapDps: 12, zapRange: 2.6 },
      ],
      branches: {
        a: { name: "Blizzard Cone", cost: 300, slow: 0.6, auraRange: 2.6, zapDps: 12, zapRange: 2.6, brittle: 3 }, // brittle linger seconds
        b: { name: "Static Zap", cost: 320, slow: 0.4, auraRange: 2.4, chain: { dmg: 30, targets: 4, decay: 0.75, jump: 1.5, rate: 1.1 }, zapRange: 2.6 },
      },
    },
    camp: {
      name: "Army Guys Camp", icon: "🪖", kind: "camp", hitsFliers: false,
      rallyRange: 2.5,
      tiers: [
      ...
      branches: {
        ...
        b: { name: "RC Racers", cost: 280, soldiers: 4, hp: 70, dmg: 7, rate: 0.7, armor: 0, respawn: 4, stun: 0.5 },
      },
    },
  };
  ...
  const ENEMIES = {
    sock: { name: "Sock Goblin", hp: 34, speed: 0.8, armor: 0, shield: 0, shieldRegen: 0, bounty: 5, lives: 1, flier: false, meleeDmg: 5, meleeRate: 0.9 },
    marble: { name: "Speedy Marble", hp: 16, speed: 1.7, armor: 0, shield: 0, shieldRegen: 0, bounty: 4, lives: 1, flier: false, meleeDmg: 3, meleeRate: 0.8 },
    balloon: { name: "Balloon Bug", hp: 40, speed: 1.1, armor: 0, shield: 0, shieldRegen: 0, bounty: 8, lives: 1, flier: true, meleeDmg: 0, meleeRate: 1 },
  };
