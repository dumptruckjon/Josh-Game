...
(function (global) {
  ...
  const LEVELS = [
    ...
    },
    {
      ...
      pads: [
        { id: "p1", cx: 1, cy: 9 }, { id: "p2", cx: 4, cy: 5 }, { id: "p3", cx: 7, cy: 8 }, { id: "p4", cx: 8, cy: 3 }, { id: "p5", cx: 8, cy: 0 }, { id: "p6", cx: 11, cy: 4 }, { id: "p7", cx: 14, cy: 1 }, { id: "p8", cx: 15, cy: 7 }, { id: "p9", cx: 11, cy: 9 }, { id: "p10", cx: 14, cy: 9 }, { id: "p11", cx: 16, cy: 13 }, { id: "p12", cx: 18, cy: 9 },
      ],
      waves: [
        ...
        { groups: [ { type: "knight", count: 5, gap: 1, delay: 0 }, { type: "mole", count: 4, gap: 0.9, delay: 3 }, { type: "marble", count: 13, gap: 0.55, delay: 4 }, { type: "hawk", count: 7, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "blob", count: 6, gap: 0.85, delay: 0 }, { type: "knight", count: 4, gap: 1, delay: 3 }, { type: "mole", count: 5, gap: 0.9, delay: 4 }, { type: "hawk", count: 9, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 6, gap: 1, delay: 0 }, { type: "mole", count: 5, gap: 0.9, delay: 3 }, { type: "blob", count: 6, gap: 0.85, delay: 4 }, { type: "hawk", count: 10, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 7, gap: 1, delay: 0 }, { type: "blob", count: 7, gap: 0.85, delay: 3 }, { type: "mole", count: 6, gap: 0.9, delay: 4 }, { type: "sock", count: 2, gap: 0.85, delay: 5 }, { type: "hawk", count: 12, gap: 0.3, delay: 2 } ] },
      ],
    },
    {
      id: 6,
      ...
      waves: [
        ...
        { groups: [ { type: "knight", count: 5, gap: 1, delay: 0 }, { type: "ghost", count: 6, gap: 0.9, delay: 3 }, { type: "sock", count: 3, gap: 0.85, delay: 4 }, { type: "hawk", count: 7, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "blob", count: 6, gap: 0.85, delay: 0 }, { type: "ghost", count: 6, gap: 0.9, delay: 3 }, { type: "marble", count: 11, gap: 0.55, delay: 4 }, { type: "hawk", count: 9, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "blob", count: 7, gap: 0.85, delay: 0 }, { type: "ghost", count: 7, gap: 0.9, delay: 3 }, { type: "knight", count: 3, gap: 1, delay: 4 }, { type: "hawk", count: 9, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 7, gap: 1, delay: 0 }, { type: "ghost", count: 8, gap: 0.9, delay: 3 }, { type: "blob", count: 5, gap: 0.85, delay: 4 }, { type: "hawk", count: 11, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 9, gap: 1, delay: 0 }, { type: "ghost", count: 9, gap: 0.9, delay: 3 }, { type: "blob", count: 6, gap: 0.85, delay: 4 }, { type: "sock", count: 3, gap: 0.85, delay: 5 }, { type: "hawk", count: 14, gap: 0.3, delay: 2 } ] },
      ],
    },
    {
      id: 7,
    ...
    },
    {
      ...
      waves: [
        ...
        { groups: [ { type: "knight", count: 8, gap: 1, delay: 0 }, { type: "battery", count: 8, gap: 0.9, delay: 3 }, { type: "balloon", count: 6, gap: 1.1, delay: 4 }, { type: "hawk", count: 13, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 10, gap: 1, delay: 0 }, { type: "battery", count: 9, gap: 0.9, delay: 3 }, { type: "blob", count: 6, gap: 0.85, delay: 4 }, { type: "hawk", count: 16, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 11, gap: 1, delay: 0 }, { type: "battery", count: 10, gap: 0.9, delay: 3 }, { type: "blob", count: 7, gap: 0.85, delay: 4 }, { type: "hawk", count: 18, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 13, gap: 1, delay: 0 }, { type: "battery", count: 12, gap: 0.9, delay: 3 }, { type: "blob", count: 9, gap: 0.85, delay: 4 }, { type: "sock", count: 5, gap: 0.85, delay: 5 }, { type: "hawk", count: 22, gap: 0.3, delay: 2 } ] },
    ...
    },
    {
      ...
      waves: [
        ...
        { groups: [ { type: "knight", count: 10, gap: 1, delay: 0 }, { type: "blob", count: 8, gap: 0.85, delay: 3 }, { type: "ghost", count: 6, gap: 0.9, delay: 4 }, { type: "hawk", count: 15, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 12, gap: 1, delay: 0 }, { type: "battery", count: 10, gap: 0.9, delay: 3 }, { type: "ghost", count: 6, gap: 0.9, delay: 4 }, { type: "hawk", count: 18, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 14, gap: 1, delay: 0 }, { type: "blob", count: 10, gap: 0.85, delay: 3 }, { type: "battery", count: 8, gap: 0.9, delay: 4 }, { type: "hawk", count: 20, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 16, gap: 1, delay: 0 }, { type: "ghost", count: 11, gap: 0.9, delay: 3 }, { type: "blob", count: 10, gap: 0.85, delay: 4 }, { type: "battery", count: 6, gap: 0.9, delay: 5 }, { type: "hawk", count: 26, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 19, gap: 1, delay: 0 }, { type: "blob", count: 13, gap: 0.85, delay: 3 }, { type: "battery", count: 10, gap: 0.9, delay: 4 }, { type: "ghost", count: 8, gap: 0.9, delay: 5 }, { type: "hawk", count: 30, gap: 0.3, delay: 2 } ] },
      ],
    },
    {
      id: 10,
      ...
      waves: [
        ...
        { groups: [ { type: "knight", count: 12, gap: 1, delay: 0 }, { type: "mole", count: 7, gap: 0.9, delay: 3 }, { type: "blob", count: 6, gap: 0.85, delay: 4 }, { type: "hawk", count: 16, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 14, gap: 1, delay: 0 }, { type: "mole", count: 9, gap: 0.9, delay: 3 }, { type: "ghost", count: 6, gap: 0.9, delay: 4 }, { type: "hawk", count: 18, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 17, gap: 1, delay: 0 }, { type: "mole", count: 9, gap: 0.9, delay: 3 }, { type: "blob", count: 9, gap: 0.85, delay: 4 }, { type: "hawk", count: 22, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 20, gap: 1, delay: 0 }, { type: "mole", count: 10, gap: 0.9, delay: 3 }, { type: "battery", count: 9, gap: 0.9, delay: 4 }, { type: "hawk", count: 26, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 23, gap: 1, delay: 0 }, { type: "mole", count: 12, gap: 0.9, delay: 3 }, { type: "blob", count: 10, gap: 0.85, delay: 4 }, { type: "ghost", count: 5, gap: 0.9, delay: 5 }, { type: "hawk", count: 31, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 27, gap: 1, delay: 0 }, { type: "mole", count: 14, gap: 0.9, delay: 3 }, { type: "blob", count: 12, gap: 0.85, delay: 4 }, { type: "battery", count: 6, gap: 0.9, delay: 5 }, { type: "hawk", count: 38, gap: 0.3, delay: 2 } ] },
      ],
    },
    {
      id: 11,
      ...
      waves: [
        ...
        { groups: [ { type: "knight", count: 15, gap: 1, delay: 0 }, { type: "mole", count: 8, gap: 0.9, delay: 3 }, { type: "ghost", count: 6, gap: 0.9, delay: 4 }, { type: "hawk", count: 32, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "pinata", count: 1, gap: 1, delay: 0 }, { type: "knight", count: 14, gap: 1, delay: 3 }, { type: "battery", count: 8, gap: 0.9, delay: 4 }, { type: "hawk", count: 34, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 20, gap: 1, delay: 0 }, { type: "mole", count: 10, gap: 0.9, delay: 3 }, { type: "blob", count: 10, gap: 0.85, delay: 4 }, { type: "hawk", count: 43, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "pinata", count: 2, gap: 1, delay: 0 }, { type: "knight", count: 17, gap: 1, delay: 3 }, { type: "battery", count: 10, gap: 0.9, delay: 4 }, { type: "hawk", count: 43, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 27, gap: 1, delay: 0 }, { type: "mole", count: 13, gap: 0.9, delay: 3 }, { type: "blob", count: 11, gap: 0.85, delay: 4 }, { type: "ghost", count: 6, gap: 0.9, delay: 5 }, { type: "hawk", count: 60, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 31, gap: 1, delay: 0 }, { type: "mole", count: 15, gap: 0.9, delay: 3 }, { type: "blob", count: 13, gap: 0.85, delay: 4 }, { type: "battery", count: 8, gap: 0.9, delay: 5 }, { type: "hawk", count: 73, gap: 0.3, delay: 2 } ] },
      ],
    },
    {
      id: 12,
      ...
      waves: [
        ...
        { groups: [ { type: "knight", count: 16, gap: 1, delay: 0 }, { type: "mole", count: 10, gap: 0.9, delay: 3 }, { type: "blob", count: 8, gap: 0.85, delay: 4 }, { type: "hawk", count: 21, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 19, gap: 1, delay: 0 }, { type: "battery", count: 11, gap: 0.9, delay: 3 }, { type: "ghost", count: 8, gap: 0.9, delay: 4 }, { type: "hawk", count: 25, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 22, gap: 1, delay: 0 }, { type: "mole", count: 13, gap: 0.9, delay: 3 }, { type: "blob", count: 10, gap: 0.85, delay: 4 }, { type: "hawk", count: 29, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 26, gap: 1, delay: 0 }, { type: "battery", count: 14, gap: 0.9, delay: 3 }, { type: "ghost", count: 11, gap: 0.9, delay: 4 }, { type: "hawk", count: 33, gap: 0.3, delay: 2 } ] },
        { groups: [ { type: "knight", count: 32, gap: 1, delay: 0 }, { type: "mole", count: 16, gap: 0.9, delay: 3 }, { type: "blob", count: 13, gap: 0.85, delay: 4 }, { type: "battery", count: 8, gap: 0.9, delay: 5 }, { type: "hawk", count: 44, gap: 0.3, delay: 2 } ] },
