...
|---|---|---|
| **TD-1 Shell+Engine** | door, gate, guards, td-mode theme, file/SW/site.test wiring, engine core (ticks, paths, spawn, Dart line, Sock/Marble, gold/lives/waves, win/lose), L1 rough, debug hooks, determinism+losability tests | L1 winnable by script in CI; gate guardrails green |
